...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen md:h-screen md:overflow-hidden text-slate-900 dark:text-slate-100 flex flex-col md:flex-row transition-colors duration-200 bg-grid-pattern relative">
